...
export const APP_VERSION = "Shibari School Admin 1.2 LIfe";

export const APP_ARCHITECTURE_SCHEMA = {
  "meta": {
    "version": "1.2 LIfe",
  ...
  "layout": {
    ...
    "responsive": true,
    "theme": "Dark (Neutral-950 + Red-600 Accents)"
  },
  "modules": [
    {
      "id": "lessons_core",
      "name": "Lesson Player",
      "ui_location": "Main Screen",
      "db_table": "lessons_shibari",
      "functions": ["Video Playback", "Text Rendering", "Glossary Highlighting", "Auth Locking (4+ locked)"]
    },
    {
      "id": "auth_system",
      "name": "Authentication",
      "ui_location": "Overlay / Sidebar Footer",
      "db_table": "user_shibari",
      "functions": ["Sign Up", "Sign In", "Profile Sync", "Role Management (Admin/User)"]
    },
    {
      "id": "marketplace",
      "name": "Shop",
      "ui_location": "Modal",
      "db_table": "market_shibari",
      "functions": ["Product List", "Filtering", "Cart Logic", "Order Emailing"]
    },
    {
      "id": "catalog",
      "name": "Video Catalog",
      "ui_location": "Modal",
      "db_table": ["catalog_videos_shibari", "catalog_categories_shibari"],
      "functions": ["Multi-select Filtering", "Video Playback"]
    },
    {
      "id": "admin_panel",
      "name": "Settings",
      "ui_location": "Modal (Admin Only)",
      "db_table": "All Tables",
      "functions": ["CRUD Operations for all content", "Image Uploads"]
    }
  ]
};
...
export const INITIAL_LESSONS: Lesson[] = LESSON_TITLES_RU.map((title, i) => {
  ...
  return {
    ...
    video_url_en: 'https://youtu.be/kIhIR9Kl8ZA',
    content: ["Контент урока на русском..."],
    content_en: CONTENT_EN_LOREM,
    related_articles: [startArticleId, startArticleId + 1, startArticleId + 2, startArticleId + 3]
  };
});
